# coding: utf-8
#
# this module is grabbed from GitHub
...
# - removed python 2 compatibility requirements
# - other fixes
#
import socketserver
...
class SimpleWebSocketServer:
    def __init__(self, host, port, websocketclass, selectTimeout=None):
        ...
        while True:
            ...
            for ready in rList:
                ...
                try:
                    ...
                    logger.exception('Packet handling error')
                    if client:
                        client.client.close()
